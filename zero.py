...
class Ui_FenetreG(object):
    ...
    def setupUi(self, FenetreG):
        ...
        FenetreG.resize(1280, 800)
        FenetreG.setEnabled(True)
        self.centralwidget = QtWidgets.QWidget(FenetreG)
        self.centralwidget.setObjectName("centralwidget")
        self.verticalLayoutWidget = QtWidgets.QWidget(self.centralwidget)
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(350, 0, 581, 481))
        self.verticalLayoutWidget.resize(280, 800)
        self.verticalLayoutWidget.setObjectName("verticalLayoutWidget")
        self.verticalLayout = QtWidgets.QVBoxLayout(self.verticalLayoutWidget)
        self.verticalLayout.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout.setObjectName("verticalLayout")
        self.verticalLayoutWidget2 = QtWidgets.QWidget(self.centralwidget)
        self.verticalLayoutWidget2.setGeometry(QtCore.QRect(650, 0, 581, 481))
        self.verticalLayoutWidget2.resize(280, 800)
        ...
        self.verticalLayoutWidget3.setGeometry(QtCore.QRect(50, 0, 581, 481))
        self.verticalLayoutWidget3.resize(280, 800)
        ...
        for evnt in self.list_action:
            ...
            cbbxC.setGeometry(QtCore.QRect(520, 100, 91, 26))
